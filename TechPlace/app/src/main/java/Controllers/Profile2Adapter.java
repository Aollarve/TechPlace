...
public class Profile2Adapter extends RecyclerView.Adapter<ProfileHolder> {
    ...
    public Profile2Adapter(List<Profile> profiles, List<String> favs, String username, Context context) {
