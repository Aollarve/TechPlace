 ...
 */
public class Profile2RecyclerFragment extends Fragment {

    private RecyclerView mRecyclerView;
    private Profile2Adapter mAdapter;
    private String mUsername;


    public Profile2RecyclerFragment() {
...
//        }
        mAdapter = new Profile2Adapter(profilesInDb, favsInDb, mUsername, getContext());
